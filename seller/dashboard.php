                ...
                <div class="d-flex flex-column gap-3 small mb-4">
                    ...
                    <div>
                        ...
                        <?php if ($current_user['seller_documents']): ?>
                            <a href="<?php echo BASE_URL; ?>/<?php echo htmlspecialchars($current_user['seller_documents']); ?>" class="text-info d-inline-block mt-1 text-decoration-none fw-bold" target="_blank">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="<?php echo BASE_URL; ?>/<?php echo htmlspecialchars($prod['image_url']); ?>" class="rounded product-thumb-sm" onerror="this.src='<?php echo BASE_URL; ?>/assets/img/placeholder.svg'" alt="Product">
                                                        <div>

...
// Remove specific folder references for universal compatibility
if (preg_match('#/(config|admin|seller|customer|includes)$#i', $base_path)) {
    $base_path = str_replace('\\', '/', dirname($base_path));
}

// Clean up if it resolves to root

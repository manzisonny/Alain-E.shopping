...
// Improve UX for non-customers before throwing generic auth error
$current_user = get_current_user_details();
if (is_logged_in() && $current_user['role'] !== 'customer') {
    $_SESSION['flash_message'] = "Please use a customer account to place orders.";
    $_SESSION['flash_type'] = "warning";
    header("Location: shop.php");
    exit;
}

// Restrict page to Customer role (handles not logged in)

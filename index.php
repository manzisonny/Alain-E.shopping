                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card-glass d-flex flex-column h-100">
                            ...
                            <div class="position-relative overflow-hidden">
                                <img src="<?php echo BASE_URL; ?>/<?php echo htmlspecialchars($prod['image_url']); ?>" alt="<?php echo htmlspecialchars($prod['name']); ?>" class="card-glass-img w-100" onerror="this.src='<?php echo BASE_URL; ?>/assets/img/placeholder.svg'">
                            ...
                            <div class="card-body p-4 d-flex flex-column flex-grow-1">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span class="star-rating"><i class="bi bi-star-fill"></i> <?php echo $prod['avg_rating'] > 0 ? number_format($prod['avg_rating'],1) : 'New'; ?></span>
                                </div>
...
<section class="container py-5">
    <div class="card-glass p-5 text-center overflow-hidden position-relative" style="background: linear-gradient(135deg, rgba(99, 102, 241, 0.1) 0%, rgba(236, 72, 153, 0.1) 100%);">
        ...
        <div class="row justify-content-center position-relative">
            <div class="col-lg-8">
                <h2 class="text-white mb-3">Become a Registered Seller on Alain-e-Shopping</h2>

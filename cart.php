                        ...
                        <div class="card-glass p-3">
                            <div class="row align-items-center gy-3">
                                ...
                                <div class="col-md-2 col-4">
                                    <img src="<?php echo BASE_URL; ?>/<?php echo htmlspecialchars($item['image_url']); ?>" alt="<?php echo htmlspecialchars($item['name']); ?>" class="img-fluid rounded" style="max-height: 80px; object-fit: contain;" onerror="this.src='<?php echo BASE_URL; ?>/assets/img/placeholder.svg'">
                                </div>
                                <!-- Descriptor -->

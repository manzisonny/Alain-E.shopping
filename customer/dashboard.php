...
if (isset($_GET['download_invoice'])) {
    ...
    if ($order_res->num_rows === 1) {
        ...
        $invoice_text = "====================================================\n";
        $invoice_text .= "               ALAIN-E-SHOPPING INVOICE\n";
        $invoice_text .= "====================================================\n";
        ...
        $invoice_text .= "====================================================\n";
        $invoice_text .= "Thank you for shopping with Alain-e-Shopping!\n";
        $invoice_text .= "For support, reach contact@alain-e-shopping.com\n";
            ...
            <div class="card-glass p-4 sticky-top" style="top: 100px; z-index: 10;">
                ...
                <div class="d-flex flex-column gap-3 small">
                    ...
                    <div>
                        ...
                        <strong class="text-white"><?php echo $current_user['created_at'] ? date('M Y', strtotime($current_user['created_at'])) : 'Unknown'; ?></strong>
                    </div>
                </div>
